...
https://github.com/munoz0raul/ew25-class-docker/tree/main/hello-c
...
The way it works is: press (esc) as many times as you want, which brings you to the command prompt (bottom screen). If you press (i or a) it allows you to insert/append.
When you finish, you can press (esc) again and type (:wq) to write and quit.

```sh
vim helloworld.c  (i) to insert
```
https://github.com/munoz0raul/ew25-class-docker/blob/main/hello-c/helloworld.c
...
vim start.sh
```
https://github.com/munoz0raul/ew25-class-docker/blob/main/hello-c/start.sh
...
- **Note:** The build-essential package is a meta-package that includes everything needed to compile software. This includes the GNU/g++ compiler collection, GNU debugger (gdb), and other libraries and tools needed for compiling a program.
...
vim Dockerfile
```
https://github.com/munoz0raul/ew25-class-docker/blob/main/hello-c/Dockerfile
...
Note: The Docker commands must be done in your hello-c folder.
...
```
https://github.com/munoz0raul/ew25-class-docker/blob/main/hello-c/docker-compose.yml
